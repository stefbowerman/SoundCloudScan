var audioElement;window.SCS={tracks:null},window.SCApp={_client_id:"a6edb50e62be5fdd8fad80afd621cdd9"},audioElement=document.createElement("audio"),audioElement.volume=.5,$(function(){var e;return window.scRadio=new Radio,window.scRadioUI=new RadioUI(".radio",".radio-screen","#track-title","#track-artist","#track-url"),window.scTrackLibrary=new TrackLibrary,SC.initialize({client_id:"a6edb50e62be5fdd8fad80afd621cdd9"}),scTrackLibrary.loadTracks(scRadio.getApiOptionsHash(),e),e=function(){var o,a;return o=scTrackLibrary.getRandomUnplayedTrack(),scRadio.playTrack(o),audioElement.pause(),window.scRadioUI.scan(),a=""+o.stream_url+"?allow_redirects=False&client_id=a6edb50e62be5fdd8fad80afd621cdd9",audioElement.setAttribute("src",a),audioElement.addEventListener("canplay",function(){return audioElement.play(),window.scRadioUI.finishScan(o)},!0),audioElement.addEventListener("ended",e)},$("#new-song").on("click",e),$("#volume-up").on("click",function(){var e;return e=audioElement.volume+.1,audioElement.volume=e>1?1:e,console.log(audioElement.volume)}),$("#volume-down").on("click",function(){var e;return e=audioElement.volume-.1,audioElement.volume=0>e?0:e,console.log(audioElement.volume)}),$(".rockable-target").on("mousedown",function(){var e;return e=$(this).parents(".control-button.rockable"),$(this).hasClass("target-top")&&e.addClass("rocked-up"),$(this).hasClass("target-bottom")?e.addClass("rocked-down"):void 0}).on("mouseup",function(){return $(this).parents(".control-button.rockable").removeClass("rocked-up rocked-down")}),setTimeout(function(){return window.scRadioUI.powerOn(),e()},1200)});
