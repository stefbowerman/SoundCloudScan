var audioElement;window.SCS={tracks:null},window.SCApp={_client_id:"a6edb50e62be5fdd8fad80afd621cdd9"},audioElement=null,$(function(){var e,t,n,a;return window.scRadio=new Radio,window.scRadioUI=new RadioUI(".radio",".radio-screen","#track-title","#track-artist","#track-url"),a=[],SC.initialize({client_id:"a6edb50e62be5fdd8fad80afd621cdd9"}),t=function(){return SC.get("/tracks",{filter:"streamable"},function(e){return window.SCS.tracks=e,n()})},e=function(){var t;return t=window.SCS.tracks[Math.floor(50*Math.random()+1)],-1===$.inArray(t.id,a)?(a.push(t.id),t):e()},n=function(){var t,n;return t=e(),window.scRadioUI.scan(),n=""+t.stream_url+"?allow_redirects=False&client_id=a6edb50e62be5fdd8fad80afd621cdd9",audioElement=document.createElement("audio"),audioElement.setAttribute("src",n),audioElement.addEventListener("canplay",function(){return audioElement.play(),window.scRadioUI.finishScan(t)},!0),setTimeout(function(){return audioElement.pause()},1e3),a.push(t.id)},$("#new-song").on("click",n),$(".rockable-target").on("mousedown",function(){var e;return e=$(this).parents(".control-button.rockable"),$(this).hasClass("target-top")&&e.addClass("rocked-up"),$(this).hasClass("target-bottom")?e.addClass("rocked-down"):void 0}).on("mouseup",function(){return $(this).parents(".control-button.rockable").removeClass("rocked-up rocked-down")}),setTimeout(function(){return window.scRadioUI.powerOn(),t()},1200)});
